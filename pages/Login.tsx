...
const Login: React.FC = () => {
  ...
  return (
    <div className="flex min-h-screen bg-white">
      <div className="w-full lg:w-1/2 flex flex-col p-8 md:p-16 lg:p-24 justify-between bg-white overflow-y-auto">
        ...
        <div className="max-w-md w-full mx-auto">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center">
              <input className="w-4 h-4 text-primary border-slate-300 rounded focus:ring-primary/20 cursor-pointer" id="remember" name="remember" type="checkbox" />
              <label className="ml-2 block text-sm text-slate-600 cursor-pointer" htmlFor="remember">Remember me for 30 days</label>
            </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-slate-500">
              ...
              <Link to="/signup" className="text-primary font-bold hover:underline ml-1">Sign up for a new account</Link>
            </p>
          </div>
        </div>
          ...
          <div className="mt-16 pt-16 border-t border-slate-200">
            <div className="flex items-center justify-center gap-4 mb-4">
              <div className="flex -space-x-2">
                <img alt="User" className="w-10 h-10 rounded-full border-2 border-white object-cover" src="https://picsum.photos/40/40?random=1" />
                <img alt="User" className="w-10 h-10 rounded-full border-2 border-white object-cover" src="https://picsum.photos/40/40?random=2" />
                <img alt="User" className="w-10 h-10 rounded-full border-2 border-white object-cover" src="https://picsum.photos/40/40?random=3" />
              </div>
